function login() {
  ...
  const url = role === 'doctor' ? 'https://hms2-production.up.railway.app/api/doctors/login' : 'https://hms2-production.up.railway.app/api/users/login';
...
function registerUser() {
  ...
  fetch("https://hms2-production.up.railway.app/api/users/register", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
